...
function Workspace({ Component, pageProps, workspace }) {
    ...
    return (
        <div onClick={() => viewexample(workspace)} className="w-[245px] h-[88px] transition-all relative cursor-pointer group flex p-2 items-center justify-center bg-slate-100/90 shadow rounded hover:shadow-xl hover:bg-gradient-to-r hover:from-[#f00] hover:to-[#ffce00] hover:text-white">
